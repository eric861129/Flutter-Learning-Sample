...
| Phase 2 | Widget 零基礎與心智模型 | [lessons/WIDGET_ZERO_TO_ONE_CSHARP.md](lessons/WIDGET_ZERO_TO_ONE_CSHARP.md), [lessons/WIDGET_MENTAL_MODEL.md](lessons/WIDGET_MENTAL_MODEL.md) | `lib/views/home_page.dart`, `lib/01_basic_widgets.dart` | Widget tree、child/children、Scaffold、ListView、事件處理 |
| Phase 3 | 狀態管理零基礎 | [lessons/STATE_MANAGEMENT_ZERO_TO_ONE_CSHARP.md](lessons/STATE_MANAGEMENT_ZERO_TO_ONE_CSHARP.md) | `lib/02_state_management.dart`, `lib/features/settings/` | setState、ViewModel、Repository、Riverpod、AsyncValue |
| Phase 4 | UI / Layout / Form | [lessons/FLUTTER_UI_GUIDE.md](lessons/FLUTTER_UI_GUIDE.md), [lessons/FORM_VALIDATION_GUIDE.md](lessons/FORM_VALIDATION_GUIDE.md) | `lib/01_basic_widgets.dart`, `lib/features/profile_form/` | layout constraints、Material 3、validator |
