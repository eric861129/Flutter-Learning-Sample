...
| 6 | SharedPreferences 與 ThemeMode：做出設定頁 | [features/settings.md](features/settings.md) |
| 7 | Riverpod、Repository、Fake Repository 怎麼一起測 | [testing_strategy.md](testing_strategy.md) |
| 8 | 沒有 Flutter 本機環境時，怎麼靠 CI 學習 | [ci_and_environment.md](ci_and_environment.md) |
